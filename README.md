...
Описание проекта представлено в [psSQL-YandexProject-4.1]
...
Файл со скриптами: [user_scripts_pr4]
...
#### Предусловия
Перед началом выполнения заданий необходимо развернуть базу данных из дампа. Дамп весит больше 25 мб, готов предоставить по запросу. Реализация всех заданий представлерна в [СР_4_2]
